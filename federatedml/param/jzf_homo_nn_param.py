...
from federatedml.protobuf.generated import jzf_nn_model_meta_pb2 as nn_model_meta_pb2
import json


class JZFHomoNNParam(BaseParam):
    """
    ...
    def __init__(self,
                 secure_aggregate: str = "plain",
                 secure_aggregate_args: list = None,
                 sparsity: float = 1.0,
        ...
        super(JZFHomoNNParam, self).__init__()
    ...
    def generate_pb(self):
        pb = nn_model_meta_pb2.JZFHomoNNParam()
