...
class JZFHomoTransferVariable(BaseTransferVariables):
    def __init__(self, flowid=0):
        super().__init__(flowid)
        self.aggregated_model = self._create_variable(name='aggregated_model')
        self.arbiter_to_guest = self._create_variable(name='arbiter_to_guest')
        self.arbiter_to_host = self._create_variable(name='arbiter_to_host')
        ...
        self.guest_to_arbiter = self._create_variable(name='guest_to_arbiter')
        self.guest_to_host = self._create_variable(name='guest_to_host')
        ...
        self.host_to_arbiter = self._create_variable(name='host_to_arbiter')
        self.host_to_guest = self._create_variable(name='host_to_guest')
