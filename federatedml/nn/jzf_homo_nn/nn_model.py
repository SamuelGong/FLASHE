...
def get_data_converter(config_type) -> DataConverter:
    from federatedml.nn.backend.tf_keras.jzf_nn_model import KerasSequenceDataConverter
...
def get_nn_builder(config_type):
    if config_type == "nn":
        ...
        from federatedml.nn.backend.tf_keras.jzf_nn_model import build_keras
        return build_keras
    else:
